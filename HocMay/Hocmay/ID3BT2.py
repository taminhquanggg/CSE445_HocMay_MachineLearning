...
df = pd.read_csv('Housing_data_price.csv', index_col = 0, parse_dates = True)# phân tích cú pháp
...
tree = lb.DecisionTreeID3(max_depth = 11, min_samples_split = 2)
...
for i in range(len(data)):
	...
	print("Tỷ lệ dự đoán đúng ",dem/len(data)*100)
